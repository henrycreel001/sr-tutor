...
function TestimonialCard({ t, index }: { t: (typeof testimonials)[0]; index: number }) {
  return (
    <AnimatedSection delay={index * 0.08}>
      <div className="bg-white rounded-2xl p-6 md:p-8 shadow-brand shadow-brand-hover h-full flex flex-col">
        <Quote className="w-8 h-8 mb-4 flex-shrink-0" style={{ color: "#F59E0B", opacity: 0.4 }} />
        <p className="text-gray-700 leading-relaxed mb-6 flex-1 italic text-sm md:text-base">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        <AnimatedSection variant="fade" className="text-center mb-14">
          ...
          <p className="text-gray-500 max-w-xl mx-auto text-lg">
            Real feedback from 500+ families who trust SR TUTOR.
          </p>
        </AnimatedSection>
